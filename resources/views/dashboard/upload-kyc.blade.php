                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="fname" value="Tgod" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="lname" value="Tgod" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="tel" value="93837373737" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="date" value="05/13/1998" class="form-control form-control-lg date-picker-alt">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div><!-- .row -->
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="add1" value="Texas" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="form-label-group">
                                                                <label class="form-label">Address Line 2 <span style="color: #808080">(optional)</span></label>
                                                            </div>
                                                            <div class="form-control-group">
                                                                <input type="text" name="add2" value="Yen 101" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="city" value="Yo" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="region" value="USA" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="nationality" value="AO" class="form-control form-control-lg date-picker-alt">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-group">
                                                                <input type="text" name="pcode" value="505" class="form-control form-control-lg">
                                                            </div>
                                                        </div>
                                                    </div><!-- .col -->
                                                </div><!-- .row -->
                                                            ...
                                                            <div class="nk-kycfm-upload-box">
                                                                <div class="upload-zone1">
                                                                    <div class="dz-message" data-dz-message>
                                                                        ...
                                                                        <input name="identity" accept=".jpg,.png,.jpeg" class="dz-message-text" type="file" required id="customFile">
                                                            ...
                                                            <div class="nk-kycfm-upload-box">
                                                                <div class="upload-zone1">
                                                                    <div class="dz-message" data-dz-message>
                                                                        ...
                                                                        <!--<span class="dz-message-or">or</span>-->
                                                                        <!--<button class="btn btn-primary">SELECT</button>-->
                                                                        <input name="address" accept=".jpg,.png,.jpeg" class="dz-message-text" type="file" required id="customFile">
                                                                        <label for="customFile">Upload Image</label>                                                               </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 d-none d-sm-block">
                                            ...
                                            <div class="nk-kycfm-footer">
                                                <div class="form-group">
                                                    <div class="custom-control custom-control-xs custom-checkbox">
                                                        ...
                                                        <label class="custom-control-label" for="tc-agree">I Have Read The <a href="https://Exnessmarket.com/terms.html">Terms Of Condition</a> And <a href="https://Exnessmarket.com/privacy.html">Privacy Policy</a></label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="custom-control custom-control-xs custom-checkbox">
                                                ...
                                                <div class="nk-kycfm-action pt-2">
                                                    <button name="upload" class="btn btn-lg btn-primary">Process for Verify</button>
                                                </div>
                                            </div><!-- .nk-kycfm-footer -->
                                        </div><!-- .nk-kycfm -->
                                    </div><!-- .card -->
