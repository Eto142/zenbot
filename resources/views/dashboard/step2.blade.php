                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        <h5 class="" style="color: white">Update Details</h5>
      ...
      <p> Please Complete All Fields</p>
                            ...
                            @csrf
                                ...
                                <div class="mt-4 d-grid">
                                    <button class="btn btn-success waves-effect waves-light"  onclick='create(this)' type="submit" id="div" style="background-color: green"">Next</button>
                                </div><br>
                                <p class="response"></p>
